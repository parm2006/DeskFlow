...
>
> **Drift check (run first)**: `git -c safe.directory='C:/Users/parth/Projects/DeskFlow' diff 8799e09 -- app/clipboard_handler.py app/client.py app/server.py app/latest_wins_sender.py tests/test_latest_wins_sender.py tests/test_clipboard_scheduling.py docs/superpowers/specs/2026-07-11-clipboard-reliability-phase-1-design.md`
